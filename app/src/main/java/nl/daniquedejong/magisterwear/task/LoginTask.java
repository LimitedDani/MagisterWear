...
package nl.daniquedejong.magisterwear.task;
...
import nl.daniquedejong.magisterwear.utils.GlobalMagister;
import nl.daniquedejong.magisterwear.utils.LoginUtils;
import nl.daniquedejong.magisterwear.utils.MagisterWearActivity;
...
public class LoginTask extends AsyncTask<Void, Void, ParcelableMagister> {
    ...
    public MagisterWearActivity activity;
    ...
    public LoginTask(MagisterWearActivity activity, School school, User user) {
